                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="mobile_no">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="state">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="field_of_specialization" class="col-md-4 col-form-label text-md-right">{{ __('Field of specialization') }}</label>
                            <div class="col-md-6">
                                <input id="field_of_specialization" type="text" class="form-control" name="field_of_specialization">
                            </div>
                        </div>
